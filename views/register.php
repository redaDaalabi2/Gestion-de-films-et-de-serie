				...
				<div class="card-body">
			      	<form method="post" class="mr-1">
			      		<div class="form-group pb-3">
				      		<input required type="text" name="nom" placeholder="Nom" class="form-control" style="border-color: black;">
				      	</div>
                        <div class="form-group py-3">
				      		<input required type="text" name="prenom" placeholder="Prenom" class="form-control" style="border-color: black;">
				      	</div>
			      		<div class="form-group py-3">
